    ...
    public void onReceive(Context context, Intent intent) {
        ...
        try {
            ...
            if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
                ...
                Log.e("bbb",content+"yy");
                int a = content.indexOf("电梯工号");
                Log.e("aaa",Integer.toString(a));
                int b = content.indexOf("请及时");
                String num = content.substring(a + 6,b-1);
                Intent aa = new Intent(context, MainActivity.class);
                aa.putExtra("Jpush", num);
